...
namespace XavSpace.Website.Controllers
{
    ...
    public class TagsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "TagId,Name,Description")] Tag tag)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "TagId,Name,Description")] Tag tag)
        {
            if (ModelState.IsValid)
            {
